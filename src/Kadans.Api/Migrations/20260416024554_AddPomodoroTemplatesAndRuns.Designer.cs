...
namespace Kadans.Api.Migrations
{
    ...
    [Migration("20260416024554_AddPomodoroTemplatesAndRuns")]
    partial class AddPomodoroTemplatesAndRuns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.PomodoroRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Api.Models.PomodoroRunPhase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Api.Models.PomodoroTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Api.Models.PomodoroTemplatePhase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Api.Models.PomodoroRun", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pomodoro_runs_asp_net_users_user_id");
            ...
            modelBuilder.Entity("Api.Models.PomodoroRunPhase", b =>
                {
                    b.HasOne("Api.Models.PomodoroRun", null)
                        .WithMany("Phases")
            ...
            modelBuilder.Entity("Api.Models.PomodoroTemplate", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pomodoro_templates_asp_net_users_user_id");
            ...
            modelBuilder.Entity("Api.Models.PomodoroTemplatePhase", b =>
                {
                    b.HasOne("Api.Models.PomodoroTemplate", null)
                        .WithMany("Phases")
            ...
            modelBuilder.Entity("Api.Models.Todo", b =>
                {
                    b.HasOne("Api.Models.PomodoroTemplate", "PomodoroTemplate")
                        .WithMany()
                        .HasForeignKey("PomodoroTemplateId")
