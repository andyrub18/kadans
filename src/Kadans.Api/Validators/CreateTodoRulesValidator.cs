...
public sealed class CreateOneTimeTodoRulesValidator : AbstractValidator<CreateOneTimeTodo>
{
...
public sealed class CreateRecurringTodoRulesValidator : AbstractValidator<CreateRecurringTodo>
{
