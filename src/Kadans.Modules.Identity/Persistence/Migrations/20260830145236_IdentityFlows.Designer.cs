...
namespace Kadans.Modules.Identity.Persistence.Migrations
{
    ...
    [Migration("20260830145236_IdentityFlows")]
    partial class IdentityFlows
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kadans.Modules.Identity.Domain.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Kadans.Modules.Identity.Domain.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Kadans.Modules.Identity.Domain.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Kadans.Modules.Identity.Domain.Device", b =>
                {
                    b.HasOne("Kadans.Modules.Identity.Domain.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Kadans.Modules.Identity.Domain.RefreshToken", b =>
                {
                    b.HasOne("Kadans.Modules.Identity.Domain.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
