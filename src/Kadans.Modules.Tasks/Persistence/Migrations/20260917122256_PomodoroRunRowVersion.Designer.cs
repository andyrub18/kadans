...
namespace Kadans.Modules.Tasks.Persistence.Migrations
{
    ...
    [Migration("20260917122256_PomodoroRunRowVersion")]
    partial class PomodoroRunRowVersion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kadans.Modules.Tasks.Domain.Todo", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("OccurrencesGeneratedThrough")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("occurrences_generated_through");
                    ...
                    b.HasIndex("OccurrencesGeneratedThrough")
            ...
            modelBuilder.Entity("Kadans.Modules.Tasks.Domain.TodoOccurrence", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("OriginalScheduledAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("original_scheduled_at");
                    ...
                    b.HasIndex("TodoId", "OriginalScheduledAt")
                        .IsUnique()
